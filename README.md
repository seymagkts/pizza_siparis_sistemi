...
### Uygulamanın .exe limki. Fotoğraflara erişemediğinden uygulama çalışırken görsel eksikliği olabilir. Ödeme tamamlandığında bulunduğu konuma orders_database.txt dosyasını otomatik oluşturur.
